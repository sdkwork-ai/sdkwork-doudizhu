# Runbook — sdkwork-doudizhu deploy / upgrade / rollback (EN)
...
targets. Image reference: `registry.sdkwork.com/apps/sdkwork-doudizhu-standalone:0.1.0`
...
install syncs the bundle to `/opt/deploy/sdkwork-doudizhu/bundle`, loads the image, starts
