...
Module `sdkwork-doudizhu` · runtime code `doudizhu` · enabled
...
| --- | --- | ---: | --- | --- |
| development | `server.development.toml` | 16 | `doudizhu-dev.sdkwork.com` | 80 |
| test | `server.test.toml` | 16 | `doudizhu-test.sdkwork.com` | 80 |
| staging | `server.staging.toml` | 16 | `doudizhu-staging.sdkwork.com` | 80 |
| demo | `server.demo.toml` | 14 | `doudizhu-demo.sdkwork.com` | 80 |
| production | `server.production.toml` | 16 | `doudizhu.sdkwork.com` | 443 ssl + 80 |
