...
| --- | --- | ---: | --- | --- |
| development | `server.development.toml` | 14 | `doudizhu-dev.sdkwork.com` | 80 |
| test | `server.test.toml` | 14 | `doudizhu-test.sdkwork.com` | 80 |
| staging | `server.staging.toml` | 14 | `doudizhu-staging.sdkwork.com` | 80 |
| production | `server.production.toml` | 14 | `doudizhu.sdkwork.com` | 443 ssl + 80 |
